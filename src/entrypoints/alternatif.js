...
const services = [
  { name: 'REMINDER', script: path.join(projectRoot, 'src/entrypoints/reminder.js'), port: 3210 },
  { name: 'LAB', script: path.join(projectRoot, 'src/entrypoints/lab.js'), port: 9000 },
  { name: 'IJIN', script: path.join(projectRoot, 'src/entrypoints/ijin.js'), port: 3000 }
];
