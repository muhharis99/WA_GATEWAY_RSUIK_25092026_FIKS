...
app.get('/', (req, res) => {
    ...
    if (ready) {
        ...
        content = '<div class="qr-wrap"><img class="qr" src="' + status.qrDataUrl + '" alt="QR WhatsApp"></div>';
    } else {
...
<title>WhatsApp Gateway · Ijin</title>
<style>
...
${ready ? '' : '<script>setTimeout(function(){location.reload()},2000)</script>'}
</body>
</html>\`);
});
